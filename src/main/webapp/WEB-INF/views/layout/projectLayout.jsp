	            ...
	            <ul class="nav metismenu" id="side-menu">
	                <li class="nav-header">
	                    <div class="dropdown profile-element"> 
	                        ...
	                        <a href="http://10.113.182.210/main">
	                            <span class="clear"> 
	                ...
	                <li>
	                    <a href="http://10.113.182.210/kcmsus"><i class="fa fa-th-large"></i> <span class="nav-label">프로젝트 홈</span></a>                    
	                </li>
	                <li>
	                    <a href="#"><i class="fa fa-table"></i> <span class="nav-label">테스트 일정</span><span class="fa arrow"></span></a>
	                    <ul class="nav nav-second-level collapse">
	                        <li><a href="http://10.113.182.210/kcmsus/activitySchedule">활동별 일정</a></li>
	                ...
	                <li>
	                    ...
	                    <ul class="nav nav-second-level collapse">
	                        <li><a href="http://10.113.182.210/kcmsus/activityList">전체 활동 목록</a></li>
	                ...
	                <li>
	                    ...
	                    <ul class="nav nav-second-level collapse">
	                        <li><a href="http://10.113.182.210/kcmsus/jobTemplateList">작업 템플릿 목록</a></li>
