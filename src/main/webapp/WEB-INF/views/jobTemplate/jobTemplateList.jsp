										...
										<div class="panel panel-success">
											<div class="panel-heading" style="height:50px;">
												<div class="row">
													...
													<div class="col-md-6">
														...
														<button type="button" class="btn btn-w-m btn-sm btn-warning" onclick="location.href='/kcmsus/jobVersionList';" style="margin-left:200px;">전체보기</button>
											...
											<div class="panel-body">
					                            <table class="table table-bordered">
					                                ...
					                                <tr>
					                                    <td>3</td>
					                                    <td><a href="/kcmsus/jobDetail">2016년 7월 1주</a></td>
					                                    <td>152</td>
					                                    <td>진행중</td>
					                                    <td>권영</td>
					                                    <th>오늘</th>
					                                ...
					                                <tr>
					                                    <td>2</td>
					                                    <td><a href="/kcmsus/jobDetail">2016년 6월 4주</a></td>
					                                    <td>252</td>
					                                    <td>완료</td>
					                                    <td>이동섭</td>
					                                    <th>어제</th>
					                                ...
					                                <tr>
					                                    <td>1</td>
					                                    <td><a href="/kcmsus/jobDetail">2016년 6월 3주</a></td>
					                                    <td>352</td>
					                                    <td>진행중</td>
					                                    <td>전평재</td>
					                                    <th>2016.6.23</th>
